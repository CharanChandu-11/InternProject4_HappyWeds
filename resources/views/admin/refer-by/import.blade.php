...
@section('title', 'Import Refer By - HappilyWeds')
...
<div class="container-fluid py-5 page-spacing font-sans">
    <div class="import-card animate-card">
        <div class="text-center mb-4">
            ...
            <h3 class="font-serif fw-bold mt-2">Import Refer By</h3>
            <p class="text-muted">Upload Excel/CSV file to import referral sources</p>
        </div>
        
        <form action="{{ route('admin.refer-by.import') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-4">
            ...
            <div class="d-flex gap-2 justify-content-center">
                <a href="{{ route('admin.refer-by.index') }}" class="btn btn-light px-4">Cancel</a>
        ...
        <div class="mt-4 pt-3 text-center">
            <small class="text-muted">
                ...
                Required columns: name, email, phone, address, status
            </small>
        </div>
    </div>
</div>
